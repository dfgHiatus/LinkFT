        ...
        Dictionary<string, List<UnifiedExpressions>> MapOscDirectXrfbUnifiedExpressions =
            new()
            {
                ...
                { "/sl/xrfb/facew/LipsToward", new List<UnifiedExpressions> { MouthClosed } },
                {
                    ...
                    new List<UnifiedExpressions> { MouthCornerPullLeft, MouthCornerSlantLeft }
                },
                {
                    "/sl/xrfb/facew/LipCornerPullerR",
                    new List<UnifiedExpressions> { MouthCornerPullRight, MouthCornerSlantRight }
                },
                ...
                {
                    "/sl/xrfb/facew/UpperLipRaiserL", new List<UnifiedExpressions> { MouthUpperUpLeft }
                }, //something odd here
                {
                    "/sl/xrfb/facew/UpperLipRaiserR", new List<UnifiedExpressions> { MouthUpperUpRight }
                }, //something odd here
                ...
                },
                {
                    ...
                    new List<UnifiedExpressions> { LipPuckerLowerRight, LipPuckerUpperRight }
                },
